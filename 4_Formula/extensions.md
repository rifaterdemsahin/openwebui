...
* 🔐 Azure Key Vault Setup: [setup_azure.md](2_Environment/setup_azure.md)
* 🛸 Fly.io Deployment Setup: [fly_io.md](2_Environment/fly_io.md)
* 🧠 Local AI Stack (Ollama + Qdrant): [setup_ai.md](2_Environment/setup_ai.md)
* 📐 Architecture & Diagrams: [architecture.md](2_Environment/architecture.md)
